...
<h1>Sobre nós</h1>
<h3>Somos a East computer, fundada em 2022 na Zona Leste de São Paulo.</h3>
<img class="imgs" src="_imagens/mapa.png">
<h5>Temos uma fábrica própria localizada ao lado do Shopping Aricanduva, em São Paulo, com fácil acesso à Marginal Tietê, e ao porto de Santos.
Nossa fábrica é especializada na montagem de computadores em esquema Just-In-time, futuramente iremos fabricar carcaças para notebooks e computadores, utilizando alta tecnologia.</h5>
<h5>A ideia de montar uma empresa que vende máquinas personalizadas nasceu inspirada na EUROCOM, empresa canadense que monta notebooks personalizados<br>
para aplicações militares, empresariais e educacionais.</h5><br>
<h5>No Brasil, há poucas empresas que vendem computadores com configuração personalizável, isso fica evidente quando vamos comprar em lojas do varejo, onde a falta de opções é grande.</h5><br>
<h5>Nossa empresa também desenvolve tecnologias para maior durabilidade, baixo consumo ou ruído, tudo isso com preço justo.</h5>
</div>
<!--rodapé-->
